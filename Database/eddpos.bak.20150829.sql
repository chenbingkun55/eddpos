...
--
-- Dumping data for table `edd_session`
--

LOCK TABLES `edd_session` WRITE;
/*!40000 ALTER TABLE `edd_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `edd_session` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-08-29 15:16:33
